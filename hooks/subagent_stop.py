#!/usr/bin/env python3
"""Send SubagentStop event to Hamlet MCP server."""
import json
import os
import sys
...
def main():
    """Send SubagentStop event and exit cleanly."""
    try:
        ...
        _log_error("SubagentStop", exc)  # GP-7: log but fail silently to Claude Code
    finally:
        sys.exit(0)
