#!/usr/bin/env python3
"""Send Notification event to Hamlet MCP server."""
import json
import sys
...
def main():
    """Send Notification event and exit cleanly."""
    try:
        ...
        _log_error("Notification", exc)  # GP-7: log but fail silently to Claude Code
    finally:
        sys.exit(0)
