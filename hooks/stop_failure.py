#!/usr/bin/env python3
"""Send StopFailure event to Hamlet MCP server."""
import json
import os
import sys
...
def main():
    """Send StopFailure event and exit cleanly."""
    try:
        ...
        _log_error("StopFailure", exc)  # GP-7: log but fail silently to Claude Code
    finally:
        sys.exit(0)
