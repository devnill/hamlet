#!/usr/bin/env python3
"""Send PostToolUseFailure event to Hamlet MCP server."""
import json
import os
import sys
...
def main():
    """Send PostToolUseFailure event and exit cleanly."""
    try:
        ...
        _log_error("PostToolUseFailure", exc)  # GP-7: log but fail silently to Claude Code
    finally:
        sys.exit(0)
